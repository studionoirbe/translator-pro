    ...
    var TranslatorPro = {
        ...
        icon: function () {
            return '<svg viewBox="0 0 16 16" width="13" height="13" aria-hidden="true" focusable="false">' +
                '<path fill="currentColor" d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1Zm4.9 4.2h-2a10.6 10.6 0 0 0-.9-2.3 5.6 5.6 0 0 1 2.9 2.3ZM8 2.5c.5.7.9 1.6 1.2 2.7H6.8c.3-1.1.7-2 1.2-2.7ZM2.6 9.4a5.5 5.5 0 0 1 0-2.8h2.3a12.4 12.4 0 0 0 0 2.8H2.6Zm.5 1.4h2a10.6 10.6 0 0 0 .9 2.3 5.6 5.6 0 0 1-2.9-2.3Zm2-5.6h-2A5.6 5.6 0 0 1 6 2.9a10.6 10.6 0 0 0-.9 2.3ZM8 13.5c-.5-.7-.9-1.6-1.2-2.7h2.4c-.3 1.1-.7 2-1.2 2.7Zm1.5-4.1h-3a11 11 0 0 1 0-2.8h3a11 11 0 0 1 0 2.8Zm.5 3.7a10.6 10.6 0 0 0 .9-2.3h2a5.6 5.6 0 0 1-2.9 2.3Zm1.1-3.7a12.4 12.4 0 0 0 0-2.8h2.3a5.5 5.5 0 0 1 0 2.8h-2.3Z"/>' +
                '</svg>';
        },
